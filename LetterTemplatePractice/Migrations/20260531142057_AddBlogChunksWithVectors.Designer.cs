...
namespace LetterTemplatePractice.Migrations
{
    ...
    [Migration("20260531142057_AddBlogChunksWithVectors")]
    partial class AddBlogChunksWithVectors
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LetterTemplate.RAG.Models.BlogChunk", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("LetterTemplatePractice.Models.NewsletterSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LetterTemplatePractice.Models.PostView", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("PostId", "Timestamp");

                    b.ToTable("PostViews");
                });

            modelBuilder.Entity("LetterTemplatePractice.Models.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ReporterId", "TargetPostId")
                        .IsUnique()
            ...
            modelBuilder.Entity("LetterTemplatePractice.Models.Report", b =>
                {
                    b.HasOne("LetterTemplatePractice.Models.ApplicationUser", "Reporter")
                        .WithMany("ReportsSubmitted")
                        .HasForeignKey("ReporterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LetterTemplatePractice.Models.ApplicationUser", "ResolvedBy")
                        .WithMany()
                    ...
                    b.HasOne("LetterTemplatePractice.Models.ApplicationUser", "TargetUser")
